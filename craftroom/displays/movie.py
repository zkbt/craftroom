...
class Movie(Display):
    ...
    def fromPDFs(self, pattern, directory=None, stride=1, bitrate=1800*10, fps=30, **kwargs):
        ...
        for i, filename in enumerate(self.filenames): #KLUDGE!
    ...
    def fromImages(self, pattern, filename='movie.gif', **kwargs):
        ...
        filename = 'stride{}'.format(stride) + fileanme
    ...
    def fromFITS(self, pattern, directory=None, stride=1, bitrate=1800*5, fps=30, **kwargs):
